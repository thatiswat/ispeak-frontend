...
export default function Enterprise() {
  return (
    <Section
      spacing="default"
      className="bg-slate-50 !py-12 lg:!py-16"
    >
      <Container>
        ...
        <div className="relative mt-10">
          ...
          <div className="relative grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {visionPoints.map((item) => (
              <article
                key={item.number}
                className="group relative flex min-h-[215px] flex-col rounded-[28px] border border-slate-200 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-[0_20px_45px_-28px_rgba(23,71,255,0.35)]"
              >
        ...
        <div className="mx-auto mt-12 max-w-4xl text-center">
          <div className="mx-auto mb-6 h-px w-12 bg-[#1747FF]" />
